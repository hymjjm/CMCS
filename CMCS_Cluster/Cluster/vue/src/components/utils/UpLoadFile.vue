...
<!--    action="http://localhost:9012/jjm-cluster-upload/import/"-->
    <el-upload
      ...
      <div style="display: flex;justify-content: center;align-items: center">
        <div slot="tip" style="text-align: center;margin-left: 10px" class="el-upload__tip">Can Only Be CSV Or TXT</div>
      </div>
...
// 检查文件格式
      ...
      if (!isCsvOrTxt) {
        this.$message.error('Only CSV or TXT files are allowed.');
