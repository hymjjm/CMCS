      ...
      <div style="overflow-x: auto; overflow-y: hidden; white-space: nowrap;">
        <table style="border-collapse: collapse; width: 100%;">
          ...
          <tr>
            ...
            <th style="padding: 10px; border: 1px solid #ddd; background-color: #f2f2f2;"><strong>WT Alle</strong></th>
            <th style="padding: 10px; border: 1px solid #ddd; background-color: #f2f2f2;"><strong>MUT Alle</strong></th>
...
export default {
  ...
  methods: {
    ...
    downloadCSV() {
      const columnNames = ["Hugo_Symbol", "Chromosome", "Start_Position", "WT Alle","MUT Alle","Strand", "Cluster","CancerType","Sample","referenceGenomes","mutDescription"];
      let csvContent = columnNames.join(",") + "\n";

      this.allHugoSymbols.forEach(symbol => {
        csvContent += `${symbol.gene},${symbol.chr},,${symbol.position},${symbol.wtAlle},${symbol.mutAlle},${symbol.strand},${symbol.cluster},${this.cancerType},${this.sample},${this.referenceGenomes},${this.mutDescription}\n`;
      });
