...
public class DBSCANUtilPlus {
    ...
    public static List<Set<Point>> RunMutCluster(List<JjmClusterUpload> JjmBrcaMaf, double eps, int minPts){
        ...
        List<Point> points = parseDataMut(JjmBrcaMaf);
...
//        System.out.println("Silhouette_score: " + Silhouette_score);
     ...
     * */
    public static List<Point> parseDataMut(List<JjmClusterUpload> JjmBrcaMaf) {
...
//            System.out.println("Current point: " + s + " with y1: " + y1 + " and y2: " + y2 + " gene: " + gene);
            ...
            if ((y1 < 1414 && y1 != 0) || (y2 < 1414 && y2 != 0)) {
                points.add(new Point(s, y1, y2, gene,currentData.getWtAllele(), currentData.getMutAllele(), currentData.getStrand(), currentData.getMutDescription()));
